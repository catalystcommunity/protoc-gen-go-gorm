...
type Thing struct {
	...
	// @gotags: fake:"skip"
	BelongsToTwoId string `protobuf:"bytes,37,opt,name=belongs_to_two_id,json=belongsToTwoId,proto3" json:"belongs_to_two_id,omitempty" fake:"skip"`
	// @gotags: fake:"skip"
	BelongsToTwo *BelongsToThing `protobuf:"bytes,38,opt,name=belongs_to_two,json=belongsToTwo,proto3" json:"belongs_to_two,omitempty" fake:"skip"`
	// @gotags: fake:"skip"
	...
	// @gotags: fake:"skip"
	BelongsToThree *BelongsToThing `protobuf:"bytes,40,opt,name=belongs_to_three,json=belongsToThree,proto3" json:"belongs_to_three,omitempty" fake:"skip"`
	// @gotags: fake:"skip"
	HasOne *HasOneThing `protobuf:"bytes,41,opt,name=has_one,json=hasOne,proto3" json:"has_one,omitempty" fake:"skip"`
	// @gotags: fake:"skip"
	HasMany []*HasManyThing `protobuf:"bytes,42,rep,name=has_many,json=hasMany,proto3" json:"has_many,omitempty" fake:"skip"`
	// @gotags: fake:"skip"
	ManyToMany []*ManyToManyThing `protobuf:"bytes,43,rep,name=many_to_many,json=manyToMany,proto3" json:"many_to_many,omitempty" fake:"skip"`
...
func (x *Thing) GetBelongsToTwoId() string {
	if x != nil {
		return x.BelongsToTwoId
	}
	return ""
}

func (x *Thing) GetBelongsToTwo() *BelongsToThing {
	if x != nil {
		return x.BelongsToTwo
	}
	return nil
}

func (x *Thing) GetAnUnexpectedId() string {
	if x != nil {
...
func (x *Thing) GetBelongsToThree() *BelongsToThing {
	if x != nil {
		return x.BelongsToThree
	}
	return nil
}
...
var file_demo_example_proto_rawDesc = []byte{
	...
	0x22, 0xbd, 0x0a, 0x0a, 0x05, 0x54, 0x68, 0x69, 0x6e, 0x67, 0x12, 0x13, 0x0a, 0x02, 0x69, 0x64,
	...
	,
	...
	0x22, 0xbe, 0x01, 0x0a, 0x0e, 0x42, 0x65, 0x6c, 0x6f, 0x6e, 0x67, 0x73, 0x54, 0x6f, 0x54, 0x68,
	0x69, 0x6e, 0x67, 0x12, 0x13, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48,
	...
	0x64, 0x22, 0xe8, 0x01, 0x0a, 0x0b, 0x48, 0x61, 0x73, 0x4f, 0x6e, 0x65, 0x54, 0x68, 0x69, 0x6e,
	...
	0x12, 0x1e, 0x0a, 0x08, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x48, 0x01, 0x52, 0x07, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x88, 0x01, 0x01,
	0x3a, 0x06, 0xba, 0xb9, 0x19, 0x02, 0x08, 0x01, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69, 0x64, 0x42,
	0x0b, 0x0a, 0x09, 0x5f, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64, 0x22, 0xe9, 0x01, 0x0a,
	0x0c, 0x48, 0x61, 0x73, 0x4d, 0x61, 0x6e, 0x79, 0x54, 0x68, 0x69, 0x6e, 0x67, 0x12, 0x13, 0x0a,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1e, 0x0a, 0x08,
	0x74, 0x68, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x48, 0x01,
	0x52, 0x07, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x88, 0x01, 0x01, 0x3a, 0x06, 0xba, 0xb9,
	0x19, 0x02, 0x08, 0x01, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69, 0x64, 0x42, 0x0b, 0x0a, 0x09, 0x5f,
	0x74, 0x68, 0x69, 0x6e, 0x67, 0x5f, 0x69, 0x64, 0x22, 0xbf, 0x01, 0x0a, 0x0f, 0x4d, 0x61, 0x6e,
	0x79, 0x54, 0x6f, 0x4d, 0x61, 0x6e, 0x79, 0x54, 0x68, 0x69, 0x6e, 0x67, 0x12, 0x13, 0x0a, 0x02,
...
var file_demo_example_proto_depIdxs = []int32{
	...
	2,  // 3: example.Thing.belongs_to_two:type_name -> example.BelongsToThing
	2,  // 4: example.Thing.belongs_to_three:type_name -> example.BelongsToThing
	3,  // 5: example.Thing.has_one:type_name -> example.HasOneThing
	4,  // 6: example.Thing.has_many:type_name -> example.HasManyThing
	5,  // 7: example.Thing.many_to_many:type_name -> example.ManyToManyThing
	0,  // 8: example.Thing.int_enum:type_name -> example.EnumOne
	0,  // 9: example.Thing.string_enum:type_name -> example.EnumOne
	0,  // 10: example.Thing.int_enum_list:type_name -> example.EnumOne
	0,  // 11: example.Thing.string_enum_list:type_name -> example.EnumOne
	6,  // 12: example.BelongsToThing.created_at:type_name -> google.protobuf.Timestamp
	6,  // 13: example.BelongsToThing.updated_at:type_name -> google.protobuf.Timestamp
	6,  // 14: example.HasOneThing.created_at:type_name -> google.protobuf.Timestamp
	6,  // 15: example.HasOneThing.updated_at:type_name -> google.protobuf.Timestamp
	6,  // 16: example.HasManyThing.created_at:type_name -> google.protobuf.Timestamp
	6,  // 17: example.HasManyThing.updated_at:type_name -> google.protobuf.Timestamp
	6,  // 18: example.ManyToManyThing.created_at:type_name -> google.protobuf.Timestamp
	6,  // 19: example.ManyToManyThing.updated_at:type_name -> google.protobuf.Timestamp
