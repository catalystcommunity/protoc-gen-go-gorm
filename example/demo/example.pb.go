...
const (
	EnumOne_One   EnumOne = 0
	EnumOne_Two   EnumOne = 1
	EnumOne_Three EnumOne = 2
)
...
type Thing struct {
	...
	IntEnum EnumOne `protobuf:"varint,40,opt,name=int_enum,json=intEnum,proto3,enum=example.EnumOne" json:"int_enum,omitempty" fake:"{number:0,2}"`
	// @gotags: fake:"{number:0,2}"
	StringEnum EnumOne `protobuf:"varint,41,opt,name=string_enum,json=stringEnum,proto3,enum=example.EnumOne" json:"string_enum,omitempty" fake:"{number:0,2}"`
}
...
var file_demo_example_proto_rawDesc = []byte{
	...
	0x0a, 0x03, 0x5f, 0x69, 0x64, 0x2a, 0x26, 0x0a, 0x07, 0x45, 0x6e, 0x75, 0x6d, 0x4f, 0x6e, 0x65,
	0x12, 0x07, 0x0a, 0x03, 0x4f, 0x6e, 0x65, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x54, 0x77, 0x6f,
	0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x54, 0x68, 0x72, 0x65, 0x65, 0x10, 0x02, 0x42, 0x3d, 0x5a,
